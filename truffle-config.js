...
const mnemonic = "napkin spell entire truly cloth maple shoe oxygen flat victory glove alone clutch worth upgrade";
...
module.exports = {
  ...
  networks: {
    ...
    ropsten: {
      provider: function() {
        return new HDWalletProvider(mnemonic, "https://ropsten.infura.io/v3/add1a5a0d87f4069814ff2e4f5165fc3")
      },
      network_id: 3
    },
    rinkeby: {
      provider: function() { 
       return new HDWalletProvider(mnemonic, "https://rinkeby.infura.io/v3/add1a5a0d87f4069814ff2e4f5165fc3");
      },
      network_id: 4,
      gasPrice: 0
  }
