...
class CharitableCauseNew extends Component {
  ...
  render() {
    return (
      <Layout>
        <h3 style={{color: 'white'}}> Create a Donation</h3>
        ...
        <Form onSubmit={this.onSubmit} error={!!this.state.errorMessage}>
          ...
          <Form.Field>
            ...
            <Input
              placeholder="Please Put Your Organization Name"
              labelPosition="left"
          ...
          <Form.Field>
            ...
            <Input
              placeholder="Please Put Your Organisation Details"
              labelPosition="left"
          ...
          <Form.Field>
            <label style={{color: 'white'}}>Country of Operation</label>
            <Dropdown
          ...
          <Form.Field>
            <label style={{color: 'white'}}>Cause Type</label>
            <Input
